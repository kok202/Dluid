...
public class MNISTAnomalyExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //Compose a map that relates each digit to a material of (score, example) pairs
