 ...
 *
 * After unsupervised training, examples are scored using the VAE type (reconstruction probability). Here, we are using the
...
public class VaeMNISTAnomaly {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("MNIST data for training");
        DataSetIterator trainIter = new MnistDataSetIterator(minibatchSize, true, rngSeed);

        System.out.println("Neural net configuration");
        ...
        System.out.println("unsupervised training");
        ...
        System.out.println("Get the variational autoencoder type:");
        ...
        System.out.println("Iterate over the test data, calculating reconstruction probabilities");
