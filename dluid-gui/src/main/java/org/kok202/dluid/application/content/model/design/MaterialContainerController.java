...
import org.kok202.dluid.application.content.material.list.MaterialList1DLayer;
import org.kok202.dluid.application.content.material.list.MaterialList2DLayer;
import org.kok202.dluid.application.content.material.list.MaterialListAdvancedLayer;
import org.kok202.dluid.application.content.material.list.MaterialListAssistantLayer;
...
public class MaterialContainerController extends AbstractController {
    ...
    public AnchorPane createView() throws Exception{
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/frame/content/model/design/material_container.fxml"));
