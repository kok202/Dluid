...
public class ComponentBatchNormalizationParamController extends AbstractLayerComponentController {
    ...
    public ComponentBatchNormalizationParamController(Layer layer) {
        super(layer);
    }
