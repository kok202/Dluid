...
public class Hexahedron {
    ...
    private Hexahedron(Point3D leftTopFront, Point3D leftTopBack,
        ...
        faces[BlockFace.FRONT.getIndex()] = new HexahedronFrontFace(
                leftTopFront,
                rightTopFront,
                leftBottomFront,
                rightBottomFront,
                this);
        faces[BlockFace.BACK.getIndex()] = new HexahedronBackFace(
                rightTopBack,
                leftTopBack,
                rightBottomBack,
                leftBottomBack,
                this);
        faces[BlockFace.LEFT.getIndex()] = new HexahedronLeftFace(
                leftTopBack,
                leftTopFront,
                leftBottomBack,
                leftBottomFront,
                this);
        faces[BlockFace.RIGHT.getIndex()] = new HexahedronRightFace(
                rightTopFront,
                rightTopBack,
                rightBottomFront,
                rightBottomBack,
                this);
        faces[BlockFace.TOP.getIndex()] = new HexahedronTopFace(
                leftTopBack,
                rightTopBack,
                leftTopFront,
                rightTopFront,
                this);
        faces[BlockFace.BOTTOM.getIndex()] = new HexahedronBottomFace(
                leftBottomFront,
                rightBottomFront,
                leftBottomBack,
                rightBottomBack,
